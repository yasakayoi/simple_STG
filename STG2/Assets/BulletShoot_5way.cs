...
public class BulletShoot_5way : MonoBehaviour
{
    public GameObject Bullet1;
    GameObject Bullet1_control;
    GameObject Bullet1_control_add;
    GameObject Bullet1_control_addadd;
    public int BulletCount;
    GameObject Bullet1_control_cut;
    GameObject Bullet1_control_cutcut;
    ...
    void FixedUpdate()
    {
        ...
        { 
            ...
            Bullet1_control_addadd=Instantiate(Bullet1,GetComponent<Rigidbody>().position,Quaternion.identity, SaveBullet.transform); //增加角度的弹道的子弹
            goal = GetOtherWayGoal(angel*2);
            Bullet1_control_addadd.GetComponent<Mover_bullet>().GetPlayerPosi(goal);
            ...
            Bullet1_control_cutcut=Instantiate(Bullet1,GetComponent<Rigidbody>().position,Quaternion.identity, SaveBullet.transform); //减少角度的弹道的子弹
            goal = GetOtherWayGoal(angel*-2);
            Bullet1_control_cutcut.GetComponent<Mover_bullet>().GetPlayerPosi(goal);
